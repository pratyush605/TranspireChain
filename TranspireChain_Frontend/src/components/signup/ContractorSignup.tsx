  ...
  return (
    ...
    <div className={stylex(signupStyle.bg_img)}>
      <div className={stylex(signupStyle.content)}>
        <header className={stylex(signupStyle.header)}>Contractor Signup</header>
        <form onSubmit={handleSubmit}>
          <div className="border border-3 border-danger rounded mt-4 form-group">
            <input className="form-control" type="text" id="id" name="id" placeholder="Contractor Id" value={id} onChange={(event) => setId(event.target.value)}/>
          </div>
          <div className="border border-3 border-danger rounded mt-4 form-group">
